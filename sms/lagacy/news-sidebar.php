...
<head>
    ...
    <title> News Sidebar || alipes || alipes HTML 5 Template </title>
    <!-- favicons Icons -->
                            ...
                            <div class="news-sidebar__content">
                                <div class="news-sidebar__single">
                                    ...
                                    <div class="news-sidebar__content-box">
                                        <ul class="list-unstyled news-sidebar__meta">
                                            <li><a href="news-details.html"><i class="fas fa-tag"></i> Apartment</a>
                                            </li>
                                        ...
                                        <h3 class="news-sidebar__title">
                                            <a href="news-details.html">the different types of luxury spaces</a>
                                        </h3>
                                ...
                                <div class="news-sidebar__single">
                                    ...
                                    <div class="news-sidebar__content-box">
                                        ...
                                        <h3 class="news-sidebar__title">
                                            <a href="news-details.html">randomised words which don't look</a>
                                        </h3>
                                        <p class="news-sidebar__text">There are many variations of passages of Lorem
                                            Ipsum available, but majority have suffered alteration in some form, by
                                            injected humour, or randomised words which don't look even slightly
                                ...
                                <div class="news-sidebar__single">
                                    ...
                                    <div class="news-sidebar__content-box">
                                        ...
                                        <h3 class="news-sidebar__title">
                                            <a href="news-details.html">There are many variations of passages</a>
                                        </h3>
                                        <p class="news-sidebar__text">There are many variations of passages of Lorem
                                            Ipsum available, but majority have suffered alteration in some form, by
                                            injected humour, or randomised words which don't look even slightly
                                        ...
                                        <div class="news-sidebar__bottom-box">
                                            ...
                                            <p class="news-sidebar__bottom-box-text">There are many variations of
                                                passages of Lorem Ipsum available, but majority have suffered alteration
                                        ...
                                        <div class="news-sidebar__delivering-services">
                                            ...
                                            <h3 class="news-sidebar__delivering-services-title"><a
                                                    href="news-details.html">Providing the best luxury apartments</a>
                                            </h3>
                                        </div>
                                        <div class="news-sidebar__load-more">
                                            <a href="news-details.html" class="thm-btn news-sidebar__load-more-btn">Load
                                                more
                                                posts</a>
                                        </div>
                                    </div>
                        ...
                        <div class="sidebar">
                                    ...
                                    <li>
                                        ...
                                        <div class="sidebar__post-content">
                                            <h3>
                                                ...
                                                <a href="news-details.html">GET BEST ADVERTISER IN YOUR SIDE POCKET</a>
                                            </h3>
                                        </div>
                                    </li>
                                    <li>
                                        ...
                                        <div class="sidebar__post-content">
                                            <h3>
                                                <span class="sidebar__post-content-meta"><i
                                                        class="fas fa-user-circle"></i>by Admin</span>
                                                <a href="news-details.html">Sed vitae leo vitae nisl pellentesque</a>
                                            </h3>
                                        </div>
                                    </li>
                                    <li>
                                        ...
                                        <div class="sidebar__post-content">
                                            <h3>
                                                <span class="sidebar__post-content-meta"><i
                                                        class="fas fa-user-circle"></i>by Admin</span>
                                                <a href="news-details.html">If you are going to use a passage</a>
                                            </h3>
                                        </div>
                                    </li>
                                </ul>
                            ...
                            <div class="sidebar__single sidebar__category">
                                ...
                                <ul class="sidebar__category-list list-unstyled">
                                    ...
                                    <li class="active"><a href="news-details.html">Luxury Rooms<span
                                                class="icon-right-arrow"></span></a></li>
                                    <li><a href="news-details.html">Apartments<span class="icon-right-arrow"></span></a>
                                    </li>
                                    <li><a href="news-details.html">
                                            Deluxe Room<span class="icon-right-arrow"></span></a></li>
                                    <li><a href="news-details.html">Property<span class="icon-right-arrow"></span></a>
                                    </li>
                                </ul>
                            </div>
