...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['photo_detail'])) {
        $valid = 0;
        $error_message .= "Photo detail Name can not be empty<br>";
    }
    ...
    if($valid == 1) {
		...
		$statement = $pdo->prepare("INSERT INTO tbl_photo (photo_caption,photo_detail,photo_name,p_category_id) VALUES (?,?,?,?)");
		$statement->execute(array($_POST['photo_caption'],$_POST['photo_detail'],$final_name,$_POST['p_category_id']));
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" name="photo_detail">
							</div>
						</div>
						<div class="form-group">
