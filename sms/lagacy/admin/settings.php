...
if(isset($_POST['form7'])) {
	...
	if(isset($_POST['home_status_team_member'])) {
		$home_status_team_member = 1;
	} else {
		$home_status_team_member = 0;
	}
	...
	$statement = $pdo->prepare("UPDATE 
	                           ...
	                           home_status_service=?, 
	                           home_title_team_member=?,
	                           home_subtitle_team_member=?,
	                           home_status_team_member=?, 
	...
	$statement->execute(array(
	                          ...
	                          $home_status_service,
	                          $_POST['home_title_team_member'],
	                          $_POST['home_subtitle_team_member'],
	                          $home_status_team_member,
									...
									<div id="collapse3" class="panel-collapse collapse">
										<div class="box-body">
											...
											<div class="form-group">
												<label for="" class="col-sm-2 control-label">Show on Home? </label>
												<div class="col-sm-9" style="padding-top:7px;">
													<input type="checkbox" name="home_status_team_member" value="<?php echo $home_status_team_member; ?>" <?php if($home_status_team_member == 1) {echo 'checked';} ?>>
												</div>
											</div>
										</div>
									</div>
