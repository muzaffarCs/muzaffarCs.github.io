...
<head>
    ...
    <title> The Building || alipes || alipes HTML 5 Template </title>
    <!-- favicons Icons -->
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="values-two__left">
                            <div class="section-title text-left">
                                <span class="section-title__tagline">about the building</span>
                                <h2 class="section-title__title">VALUES OF SMART LIVING IN luxury apartment</h2>
                            </div>
                            <p class="values-two__text-1">There are many variations of passages of psum available, but
                                the majority have suffered alteration in some form, by injected humour, or randomised
                                words.</p>
                            <div class="values-two__points-box">
                                <ul class="list-unstyled values-two__points">
                                    <li>
                                        <div class="icon">
                                ...
                                <ul class="list-unstyled values-two__points values-two__points-two">
                                    <li>
                                        <div class="icon">
                                            <i class="fa fa-check"></i>
                                        </div>
                                ...
                                <ul class="list-unstyled values-two__points values-two__points-three">
                                    <li>
                                        <div class="icon">
                                            <i class="fa fa-check"></i>
                                        </div>
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="values-two__right">
                            <div class="values-two__img">
                                <img src="assets/images/resources/values-2-1.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="about-building">
            <div class="about-building__bg"
                style="background-image: url(assets/images/backgrounds/about-building-bg.png);"></div>
            <div class="container">
                <div class="row">
                    <div class="col-xl-6 col-lg-6">
                        <div class="about-building__left">
                            <div class="about-building__img">
                                <img src="assets/images/resources/about-building-img-1.jpg" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6">
                        <div class="about-building__right">
                            <div class="section-title text-left">
                                <span class="section-title__tagline">about the building</span>
                                <h2 class="section-title__title">Apartment INTERIORS & DESIGNERS</h2>
                            </div>
                            <p class="about-building__text-1">There are many variations of passages of psum available,
                                but the majority have suffered alteration in some form, by injected humour, or
                                randomised words which don't look even slightly believable.</p>
                            <p class="about-building__text-2">If you are going to use a passage of you need to be sure
            ...
            <div class="container">
                <div class="video-one__img-box">
                    <div class="video-one__bg"
                        style="background-image: url(assets/images/backgrounds/video-one-bg-img-1.jpg);"></div>
                    ...
                    <div class="video-one__title">
                        <h3>Our building <br>video tour</h3>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="amenities">
            <div class="amenities__shape-1 img-bounce">
                <img src="assets/images/shapes/ameneties-shape-1.png" alt="">
            </div>
            <div class="container">
                <div class="section-title text-center">
                    <span class="section-title__tagline">about the building</span>
                    <h2 class="section-title__title">property amenities & <br> features</h2>
                </div>
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="100ms">
                        <div class="amenities__single">
                            ...
                            <h3 class="amenities__title"><a href="services.html">Smart & High tech <br> living style</a>
                            </h3>
                            <p class="amenities__text">Aliq is notm hendr erit a augue insu image pellen tes.</p>
                            <a href="services.html" class="thm-btn amenities__btn">Read More</a>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="200ms">
                        <div class="amenities__single">
                            ...
                            <h3 class="amenities__title"><a href="services.html">Attractive building <br> location</a>
                            </h3>
                            <p class="amenities__text">Aliq is notm hendr erit a augue insu image pellen tes.</p>
                            <a href="services.html" class="thm-btn amenities__btn">Read More</a>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="300ms">
                        <div class="amenities__single">
                            ...
                            <h3 class="amenities__title"><a href="services.html">Eco & Luxury building <br>
                                    construction</a></h3>
                            <p class="amenities__text">Aliq is notm hendr erit a augue insu image pellen tes.</p>
                            <a href="services.html" class="thm-btn amenities__btn">Read More</a>
                        </div>
