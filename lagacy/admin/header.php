...
<head>
	...
	<title>Construct - Admin Panel</title>
	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="index.php" class="logo">
				<span class="logo-lg">Construct</span>
			</a>
  		...
  		<aside class="main-sidebar">
    		<section class="sidebar">
      			...
      			<ul class="sidebar-menu">
					...
					<li class="treeview <?php if( ($cur_page == 'category-add.php')||($cur_page == 'category.php')||($cur_page == 'category-edit.php') || ($cur_page == 'news-add.php')||($cur_page == 'apartments.php')||($cur_page == 'news-edit.php') || ($cur_page == 'comment.php') ) {echo 'active';} ?>">
						<a href="#">
						...
						<ul class="treeview-menu">
							...
							<li><a href="apartments.php"><i class="fa fa-circle-o"></i> Apartment</a></li>
