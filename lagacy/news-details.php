...
<head>
    ...
    <title> News Details || alipes || alipes HTML 5 Template </title>
    <!-- favicons Icons -->
                    ...
                    <div class="col-xl-8 col-lg-7">
                        <div class="news-details__left">
                            ...
                            <div class="news-details__content">
                                ...
                                <h3 class="news-details__title">the different types of luxury spaces</h3>
                            ...
                            <div class="news-details__pagenation-box">
                                <ul class="list-unstyled news-details__pagenation">
                                    <li>A perfect blend of breathtaking architecture</li>
                                    <li>Benefits of using our breathtaking architecture</li>
                                </ul>
                            </div>
                            ...
                            <div class="comment-form">
                                ...
                                <form action="https://layerdrops.com/alipes/main-html/assets/inc/sendemail.php" class="comment-one__form contact-form-validated"
